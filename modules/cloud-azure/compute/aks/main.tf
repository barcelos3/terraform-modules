...
resource "azurerm_kubernetes_cluster" "main" {
  ...
  name                                = var.cluster_name == null ? "aks-${var.prefix}" : var.cluster_name
...
resource "azurerm_log_analytics_workspace" "main" {
  ...
  location            = coalesce(var.location, data.azurerm_resource_group.main.location)
  name                = var.cluster_log_analytics_workspace_name == null ? "log-${var.prefix}" : var.cluster_log_analytics_workspace_name
