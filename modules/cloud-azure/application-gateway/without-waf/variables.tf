...
variable "domain_name_label" {
  description = "(Optional) Domain label to use for the Application Gateway."
  type        = string
  default     = null
}
...
variable "appgw_scale_max" {
  description = "(Required) Maximum capacity for autoscaling. Accepted values are in the range 2 to 125."
  type        = number
  default     = 2
}
